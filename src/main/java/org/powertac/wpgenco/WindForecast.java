...
public class WindForecast {
	...
	public void refreshWeatherForecast() {
		...
		WeatherForecast weatherForecast = weatherForecastRepo.currentWeatherForecast();
		List<WeatherForecastPrediction> windPredictions = weatherForecast.getPredictions();
